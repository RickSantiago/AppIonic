...
const DEFAULT_RESOURCES_DIR = path.resolve(__dirname, '..', '..', 'assets', 'cordova', 'default-resources');
/**
...
function addDefaultImagesToProjectResources(projectDirectory, platform) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield fs_1.fsMkdirp(platformResourceDir);
        yield fs_1.copyDirectory(platformResourceDir, resourcesDir);
    });
}
